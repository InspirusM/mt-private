...
module.exports = class extends Command {
	...
	constructor(...args) {
		super(...args, {
			...
			description: 'Fast forwards a track to certain position',
            category: 'Music',
	...
	async run(msg, args, data) {
        ...
        if(ms > player.queue.current.duration) return msg.channel.send({embed: {
            ...
            title: `${this.client.emoji.error} | You cannot seek beyond the track length`
        }});
        ...
        return msg.channel.send({embed: {
            ...
            description: `Song seeked to ${prettyMs(ms)}`
        }});
    };
};
