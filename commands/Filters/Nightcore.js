...
module.exports = class extends Command {
	...
	constructor(...args) {
		super(...args, {
			aliases: ['ncore'],
			description: 'Adds nightcore effect to a track',
	...
	async run(msg, args, data) {
        ...
        if (args[0] && (args[0].toLowerCase() == 'reset' || args[0].toLowerCase() == 'off')) msg.client.setFilter(msg, player, 'nightcore', false);
        else msg.client.setFilter(msg, player, 'nightcore', true);    
    }
};
