...
module.exports = class extends Command {
	...
	async run(msg, args, data) {
        ...
        if (args[0] && (args[0].toLowerCase() == 'reset' || args[0].toLowerCase() == 'off')) msg.client.setFilter(msg, player, 'bassboost', false);
        else msg.client.setFilter(msg, player, 'bassboost', true);    
    }
};
